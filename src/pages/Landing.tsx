...
export default function Landing() {
  return (
    <div className="min-h-screen flex justify-center bg-gradient-to-br from-purple-400 to-purple-200">
      <div className="container">
        <div className="h-16">
          <div className="flex justify-between items-center h-full">
            <div className="flex items-center gap-2">
              <img src={Logo} className="h-11" alt="logo" />
              <p className="text-2xl">Vconnect</p>
            </div>
            <div className="flex items-center gap-11">
              <Link to={"/contact-us"} className="hover:text-violet-600">
                Contact Us
              </Link>
              <Link
        ...
        <div className="mt-16">
          <h1 className="text-center text-5xl font-bold bg-gradient-to-r from-violet-600 to-violet-900 text-transparent bg-clip-text">
            Connect with your lovable one in Any Time
          </h1>
        </div>
        <div className="mt-4 flex items-center flex-col">
          <h1 className="text-violet-800 w-4/5">
          ...
          <div className="mt-5 w-4/5 flex justify-around">
          ...
          <Link
            to={"/login"}
            className="mt-10 group rounded-full bg-violet-600 hover:bg-violet-700 text-white px-6 py-3 flex gap-2 items-center"
          >
            Let's Go
            <IoIosArrowForward size={18} className="transform duration-150 group-hover:translate-x-1"/>
          </Link>
        </div>
      </div>
    </div>
