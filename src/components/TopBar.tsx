    ...
    <div className="h-14 sm:h-16 w-full px-3 sm:px-4 shadow-md flex justify-between items-center">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative">
          <IoEllipsisVertical onClick={handleToggleMenu} className="text-2xl sm:text-3xl text-slate-700 cursor-pointer" />
          <div className={`bg-slate-50 absolute w-32 h-auto right-2 top-10 rounded shadow-lg p-2 z-10 ${menuVisibility ? "flex" : "hidden"}`}>
            <ul className="flex flex-col justify-center w-full">
              <li className="flex items-center gap-2 p-1 hover:bg-slate-200 rounded cursor-pointer">
