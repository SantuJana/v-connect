...
export default function UserCard() {
  return (
    <div className="p-3 bg-white border-1 border-violet-300 shadow-lg w-72 min-h-32 rounded-lg">
      <div className="flex gap-3 items-start w-full">
        ...
        <div className="w-full">
          <div className="flex items-start w-full">
            <p className="text-lg flex-1 text-violet-600 font-semibold leading-tight">
              Natasha Roy
            </p>
          ...
          <p className="text-violet-600 text-md leading-tight">26 years old</p>
          <p className="text-violet-600 text-md leading-tight">Kolkata</p>
        </div>
      </div>
